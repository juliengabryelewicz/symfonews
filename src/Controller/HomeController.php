...
class HomeController extends AbstractController
{
    ...
    public function search(Request $request, NewsService $newsService, FavoriteRepository $favoriteRepository): Response
    {
        return $this->render('home/index.html.twig', [
            'news' => $newsService->getPaginatedNews($request->query->get("q")),
            'favorites' => $favoriteRepository->getAllGuids()
        ]);
    }
}
